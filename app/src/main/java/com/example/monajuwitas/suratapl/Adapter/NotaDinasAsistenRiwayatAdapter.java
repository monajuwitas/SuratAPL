...
public class NotaDinasAsistenRiwayatAdapter extends RecyclerView.Adapter<NotaDinasAsistenRiwayatAdapter.Viewholder> {
    private List<NDModel> mItems;

    public NotaDinasAsistenRiwayatAdapter(List<NDModel> NDModelList) {
        super();
    ...
    @NonNull
    @Override
    public NotaDinasAsistenRiwayatAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull NotaDinasAsistenRiwayatAdapter.Viewholder viewholder, int i) {
