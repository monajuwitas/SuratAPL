...
public class SPTAccAdapter extends RecyclerView.Adapter<SPTAccAdapter.Viewholder> {
    List<SPTModel> mItems;

    public SPTAccAdapter(List<SPTModel> SPTModelList) {
        super();
    ...
    @NonNull
    @Override
    public SPTAccAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SPTAccAdapter.Viewholder viewholder, int i) {
