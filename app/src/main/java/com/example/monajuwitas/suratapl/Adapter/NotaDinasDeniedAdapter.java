...
public class NotaDinasDeniedAdapter extends RecyclerView.Adapter<NotaDinasDeniedAdapter.Viewholder> {
    List<NDModel> mItems;
    public NotaDinasDeniedAdapter(List<NDModel> NDModelList) {
        super();
    ...
    @NonNull
    @Override
    public NotaDinasDeniedAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull NotaDinasDeniedAdapter.Viewholder viewholder, int i) {
