...
public class SPTAdapter extends RecyclerView.Adapter<SPTAdapter.Viewholder>{
    private List<SPTModel> mItems;

    public SPTAdapter(List<SPTModel> SPTModelList) {
        super();
    ...
    @NonNull
    @Override
    public SPTAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SPTAdapter.Viewholder viewholder, int i) {
