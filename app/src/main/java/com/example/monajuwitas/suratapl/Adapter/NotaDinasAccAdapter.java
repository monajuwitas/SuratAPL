...
public class NotaDinasAccAdapter extends RecyclerView.Adapter<NotaDinasAccAdapter.Viewholder> {
    private List<NDModel> mItems;
    public NotaDinasAccAdapter(List<NDModel> NDModelList) {
        super();
    ...
    @NonNull
    @Override
    public NotaDinasAccAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull NotaDinasAccAdapter.Viewholder viewholder, int i) {
