...
public class EofficeDeniedAdapter extends RecyclerView.Adapter<EofficeDeniedAdapter.Viewholder> {
    private  List<EofficeModel> mItems;


    public EofficeDeniedAdapter(List<EofficeModel> eofficeModelList) {
        super();
    ...
    @NonNull
    @Override
    public EofficeDeniedAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull EofficeDeniedAdapter.Viewholder viewholder, int i) {
